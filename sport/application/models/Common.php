...
class Common extends CI_Model
{
	...
	{
		$this->db->select('SE.id,SE.link,SE.title,SE.latitude,SE.longitude,SE.event_address,SE.price,SE.join_user,SE.price,SE.event_image,SE.join_user,SE.user_id,SE.game_id,SG.game_image,SE.event_user_type,SE.event_time,SE.event_duration,SE.event_participant_no,SE.event_description,SE.status,SG.game_name,');
	...
	{
		$this->db->select('U.id,U.name,U.email,U.image,NT.message,NT.date,NT.type,NT.event_id,NT.id as Notification_id,NT.unique_id as unique_id');
	...
	public function get_eventList_by_lat($where,$user_latitude,$user_longitude)
	{
		...
		$this->db->select('SE.id,SE.link,SE.title,SE.latitude,SE.longitude,SE.event_address,SE.join_user,SE.event_image,SE.price,SE.join_user,SE.user_id,SE.game_id,SG.game_image,SE.event_user_type,SE.event_time,SE.event_duration,SE.event_participant_no,SE.event_description,SE.status,SG.game_name, (
     3959 * acos (
