	...
	public function chat()
	{
		...
		if(!empty($_REQUEST['user_from']))
		{
			...
			if($result)
			{
				...
				$notification = array('user_id' => $user_to,'message' => "Sent You a Message",'user_send_from'=>$_REQUEST['user_from'],'date'=>$today,'type'=>"Message",'from_name'=>$from_name_not,'from_name'=>$from_name_not,'from_image'=>$from_image_not);
