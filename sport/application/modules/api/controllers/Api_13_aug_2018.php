...
;
	...
	public function user_list()
	{
		...
		$arr[]=array('id'=>$value['id'],'name'=>$value['name'],'email'=>$value['email'],'image'=>$image,'follow_status'=>$follow_status,'block_status'=>$block_status,'created_at'=>$created_at);
		}
